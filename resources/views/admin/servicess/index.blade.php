                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex justify-end m-2">
                                     ...
                                     <a href="{{ route('services.create') }}" class="p-3 bg-blue-700 rounded-md text-white font-bold"><i class="fas fa-plus mr-2"></i>Ajouter un service</a>
                                </div>
                            </div>
                        </div>
               ...
               <div class="alert alert-primary alert-dismissible fade show">
                ...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 ...
                 @endif
                        ...
                        <h1 class="text-3xl text-black-500 mb-3 mt-10"> Liste des <span class="text-blue-600"> services</span> </h1>
